...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-base-out-structure))
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-offset-2d))
  (cffi:with-foreign-slots
      ((%vk:x
        %vk:y)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-offset-3d))
  (cffi:with-foreign-slots
      ((%vk:x
        %vk:y
        %vk:z)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-extent-2d))
  (cffi:with-foreign-slots
      ((%vk:width
        %vk:height)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-extent-3d))
  (cffi:with-foreign-slots
      ((%vk:width
        %vk:height
        %vk:depth)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-viewport))
  (cffi:with-foreign-slots
      ((%vk:x
        %vk:y
        %vk:width
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-rect-2d))
  (cffi:with-foreign-slots
      ((%vk:offset
        %vk:extent)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-clear-rect))
  (cffi:with-foreign-slots
      ((%vk:rect
        %vk:base-array-layer
        %vk:layer-count)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-component-mapping))
  (cffi:with-foreign-slots
      ((%vk:r
        %vk:g
        %vk:b
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-properties))
  (cffi:with-foreign-slots
      ((%vk:api-version
        %vk:driver-version
        %vk:vendor-id
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-extension-properties))
  (cffi:with-foreign-slots
      ((%vk:extension-name
        %vk:spec-version)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-layer-properties))
  (cffi:with-foreign-slots
      ((%vk:layer-name
        %vk:spec-version
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-application-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-allocation-callbacks))
  (cffi:with-foreign-slots
      ((%vk:p-user-data
        %vk:pfn-allocation
        %vk:pfn-reallocation
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-queue-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-instance-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-queue-family-properties))
  (cffi:with-foreign-slots
      ((%vk:queue-flags
        %vk:queue-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-memory-properties))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-requirements))
  (cffi:with-foreign-slots
      ((%vk:size
        %vk:alignment
        %vk:memory-type-bits)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-image-format-properties))
  (cffi:with-foreign-slots
      ((%vk:aspect-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-image-memory-requirements))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-type))
  (cffi:with-foreign-slots
      ((%vk:property-flags
        %vk:heap-index)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-heap))
  (cffi:with-foreign-slots
      ((%vk:size
        %vk:flags)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-mapped-memory-range))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-format-properties))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-format-properties))
  (cffi:with-foreign-slots
      ((%vk:max-extent
        %vk:max-mip-levels
        %vk:max-array-layers
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-buffer-info))
  (cffi:with-foreign-slots
      ((%vk:buffer
        %vk:offset
        %vk:range)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-image-info))
  (cffi:with-foreign-slots
      ((%vk:sampler
        %vk:image-view
        %vk:image-layout)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-write-descriptor-set))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:dst-set
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-copy-descriptor-set))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-set
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-view-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-subresource))
  (cffi:with-foreign-slots
      ((%vk:aspect-mask
        %vk:mip-level
        %vk:array-layer)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-subresource-layers))
  (cffi:with-foreign-slots
      ((%vk:aspect-mask
        %vk:mip-level
        %vk:base-array-layer
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-subresource-range))
  (cffi:with-foreign-slots
      ((%vk:aspect-mask
        %vk:base-mip-level
        %vk:level-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-barrier))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-access-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-memory-barrier))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-access-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-memory-barrier))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-access-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subresource-layout))
  (cffi:with-foreign-slots
      ((%vk:offset
        %vk:size
        %vk:row-pitch
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-view-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-copy))
  (cffi:with-foreign-slots
      ((%vk:src-offset
        %vk:dst-offset
        %vk:size)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-memory-bind))
  (cffi:with-foreign-slots
      ((%vk:resource-offset
        %vk:size
        %vk:memory
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-image-memory-bind))
  (cffi:with-foreign-slots
      ((%vk:subresource
        %vk:offset
        %vk:extent
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-buffer-memory-bind-info))
  (cffi:with-foreign-slots
      ((%vk:buffer
        %vk:bind-count
        %vk:p-binds)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-image-opaque-memory-bind-info))
  (cffi:with-foreign-slots
      ((%vk:image
        %vk:bind-count
        %vk:p-binds)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-image-memory-bind-info))
  (cffi:with-foreign-slots
      ((%vk:image
        %vk:bind-count
        %vk:p-binds)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-sparse-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-copy))
  (cffi:with-foreign-slots
      ((%vk:src-subresource
        %vk:src-offset
        %vk:dst-subresource
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-blit))
  (cffi:with-foreign-slots
      ((%vk:src-subresource
        %vk:src-offsets
        %vk:dst-subresource
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-resolve))
  (cffi:with-foreign-slots
      ((%vk:src-subresource
        %vk:src-offset
        %vk:dst-subresource
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-shader-module-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-pool-size))
  (cffi:with-foreign-slots
      ((%vk:type
        %vk:descriptor-count)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-pool-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-set-allocate-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:descriptor-pool
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-specialization-map-entry))
  (cffi:with-foreign-slots
      ((%vk:constant-id
        %vk:offset
        %vk:size)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-specialization-info))
  (cffi:with-foreign-slots
      ((%vk:map-entry-count
        %vk:p-map-entries
        %vk:data-size
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-shader-stage-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-compute-pipeline-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-vertex-input-binding-description))
  (cffi:with-foreign-slots
      ((%vk:binding
        %vk:stride
        %vk:input-rate)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-vertex-input-attribute-description))
  (cffi:with-foreign-slots
      ((%vk:location
        %vk:binding
        %vk:format
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-vertex-input-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-input-assembly-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-tessellation-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-viewport-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-rasterization-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-multisample-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-color-blend-attachment-state))
  (cffi:with-foreign-slots
      ((%vk:blend-enable
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-color-blend-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-stencil-op-state))
  (cffi:with-foreign-slots
      ((%vk:fail-op
        %vk:pass-op
        %vk:depth-fail-op
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-depth-stencil-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-graphics-pipeline-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-cache-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-cache-header-version-one))
  (cffi:with-foreign-slots
      ((%vk:header-size
        %vk:header-version
        %vk:vendor-id
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-push-constant-range))
  (cffi:with-foreign-slots
      ((%vk:stage-flags
        %vk:offset
        %vk:size)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-layout-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sampler-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-pool-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-buffer-allocate-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:command-pool
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-buffer-inheritance-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:render-pass
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-buffer-begin-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-begin-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:render-pass
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-clear-depth-stencil-value))
  (cffi:with-foreign-slots
      ((%vk:depth
        %vk:stencil)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-clear-attachment))
  (cffi:with-foreign-slots
      ((%vk:aspect-mask
        %vk:color-attachment
        %vk:clear-value)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-description))
  (cffi:with-foreign-slots
      ((%vk:flags
        %vk:format
        %vk:samples
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-reference))
  (cffi:with-foreign-slots
      ((%vk:attachment
        %vk:layout)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-description))
  (cffi:with-foreign-slots
      ((%vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-dependency))
  (cffi:with-foreign-slots
      ((%vk:src-subpass
        %vk:dst-subpass
        %vk:src-stage-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-event-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-fence-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-features))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-sparse-properties))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-limits))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-query-pool-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-framebuffer-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-draw-indirect-command))
  (cffi:with-foreign-slots
      ((%vk:vertex-count
        %vk:instance-count
        %vk:first-vertex
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-draw-indexed-indirect-command))
  (cffi:with-foreign-slots
      ((%vk:index-count
        %vk:instance-count
        %vk:first-index
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-dispatch-indirect-command))
  (cffi:with-foreign-slots
      ((%vk:x
        %vk:y
        %vk:z)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-multi-draw-info-ext))
  (cffi:with-foreign-slots
      ((%vk:first-vertex
        %vk:vertex-count)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-multi-draw-indexed-info-ext))
  (cffi:with-foreign-slots
      ((%vk:first-index
        %vk:index-count
        %vk:vertex-offset)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-submit-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:wait-semaphore-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:display
        %vk:display-name
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-plane-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:current-display
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-mode-parameters-khr))
  (cffi:with-foreign-slots
      ((%vk:visible-region
        %vk:refresh-rate)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-mode-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:display-mode
        %vk:parameters)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-mode-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-plane-capabilities-khr))
  (cffi:with-foreign-slots
      ((%vk:supported-alpha
        %vk:min-src-position
        %vk:max-src-position
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-surface-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-present-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-rect
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-capabilities-khr))
  (cffi:with-foreign-slots
      ((%vk:min-image-count
        %vk:max-image-count
        %vk:current-extent
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-android-surface-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-vi-surface-create-info-nn))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-wayland-surface-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-win32-surface-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-xlib-surface-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-xcb-surface-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-direct-fb-surface-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-pipe-surface-create-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-stream-descriptor-surface-create-info-ggp))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-screen-surface-create-info-qnx))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-format-khr))
  (cffi:with-foreign-slots
      ((%vk:format
        %vk:color-space)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-swapchain-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-present-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:wait-semaphore-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-report-callback-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-validation-flags-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-validation-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-rasterization-state-rasterization-order-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-marker-object-name-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:object-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-marker-object-tag-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:object-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-marker-marker-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-marker-name
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-dedicated-allocation-buffer-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:dedicated-allocation)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-dedicated-allocation-memory-allocate-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-image-format-properties-nv))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-memory-image-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-memory-allocate-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-memory-win32-handle-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-memory-win32-handle-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-attributes
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-win32-keyed-mutex-acquire-release-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:acquire-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-device-generated-commands-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-private-data-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-private-data-slot-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-private-data-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:private-data)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-device-generated-commands-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-multi-draw-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-graphics-shader-group-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:stage-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-graphics-pipeline-shader-groups-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:group-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-shader-group-indirect-command-nv))
  (cffi:with-foreign-slots
      ((%vk:group-index)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-index-buffer-indirect-command-nv))
  (cffi:with-foreign-slots
      ((%vk:buffer-address
        %vk:size
        %vk:index-type)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-vertex-buffer-indirect-command-nv))
  (cffi:with-foreign-slots
      ((%vk:buffer-address
        %vk:size
        %vk:stride)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-set-state-flags-indirect-command-nv))
  (cffi:with-foreign-slots
      ((%vk:data)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-indirect-commands-stream-nv))
  (cffi:with-foreign-slots
      ((%vk:buffer
        %vk:offset)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-indirect-commands-layout-token-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:token-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-indirect-commands-layout-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-generated-commands-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:pipeline-bind-point
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-generated-commands-memory-requirements-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:pipeline-bind-point
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-features-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:features)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-properties-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:properties)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-format-properties-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:format-properties)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-format-properties-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image-format-properties)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-image-format-info-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:format
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-queue-family-properties-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-memory-properties-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-image-format-properties-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:properties)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-sparse-image-format-info-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:format
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-push-descriptor-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-conformance-version))
  (cffi:with-foreign-slots
      ((%vk:major
        %vk:minor
        %vk:subminor
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-driver-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:driver-id
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-present-regions-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:swapchain-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-rect-layer-khr))
  (cffi:with-foreign-slots
      ((%vk:offset
        %vk:extent
        %vk:layer)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-variable-pointers-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-memory-properties))
  (cffi:with-foreign-slots
      ((%vk:external-memory-features
        %vk:export-from-imported-handle-types
        %vk:compatible-handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-external-image-format-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-image-format-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-external-buffer-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-buffer-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:external-memory-properties)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-id-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-uuid
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-memory-image-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-memory-buffer-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-memory-allocate-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-memory-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-memory-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-attributes
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-memory-zircon-handle-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-zircon-handle-properties-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory-type-bits)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-get-zircon-handle-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-win32-handle-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory-type-bits)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-get-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-memory-fd-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-fd-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory-type-bits)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-get-fd-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-win32-keyed-mutex-acquire-release-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:acquire-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-external-semaphore-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-semaphore-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:export-from-imported-handle-types
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-semaphore-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-semaphore-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-semaphore-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-attributes
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-d-3d-1-2-fence-submit-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-get-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-semaphore-fd-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-get-fd-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-semaphore-zircon-handle-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-get-zircon-handle-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-external-fence-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-fence-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:export-from-imported-handle-types
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-fence-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-types)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-fence-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:fence
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-export-fence-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-attributes
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-fence-get-win32-handle-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:fence
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-fence-fd-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:fence
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-fence-get-fd-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:fence
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-multiview-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:multiview
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-multiview-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-multiview-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:subpass-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-capabilities-2-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:min-image-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-power-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:power-state)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-event-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-event)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-event-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:display-event)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-swapchain-counter-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:surface-counters)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-group-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-buffer-memory-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:buffer
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-buffer-memory-device-group-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-image-memory-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-image-memory-device-group-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-index-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-render-pass-begin-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-command-buffer-begin-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-mask)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-submit-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:wait-semaphore-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-bind-sparse-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-present-capabilities-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:present-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-image-memory-swapchain-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:swapchain
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acquire-next-image-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:swapchain
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-present-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:swapchain-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-device-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:physical-device-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-group-swapchain-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:modes)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-update-template-entry))
  (cffi:with-foreign-slots
      ((%vk:dst-binding
        %vk:dst-array-element
        %vk:descriptor-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-update-template-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-x-y-color-ext))
  (cffi:with-foreign-slots
      ((%vk:x
        %vk:y)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-present-id-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:present-id)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-present-id-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:swapchain-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-present-wait-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:present-wait)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-hdr-metadata-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-native-hdr-surface-capabilities-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-swapchain-display-native-hdr-create-info-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-refresh-cycle-duration-google))
  (cffi:with-foreign-slots
      ((%vk:refresh-duration)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-past-presentation-timing-google))
  (cffi:with-foreign-slots
      ((%vk:present-id
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-present-times-info-google))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:swapchain-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-ios-surface-create-info-mvk))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-mac-os-surface-create-info-mvk))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-metal-surface-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-viewport-w-scaling-nv))
  (cffi:with-foreign-slots
      ((%vk:xcoeff
        %vk:ycoeff)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-viewport-w-scaling-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-viewport-swizzle-nv))
  (cffi:with-foreign-slots
      ((%vk:x
        %vk:y
        %vk:z
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-viewport-swizzle-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-discard-rectangle-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-discard-rectangle-state-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-input-attachment-aspect-reference))
  (cffi:with-foreign-slots
      ((%vk:subpass
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-input-attachment-aspect-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-surface-info-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:surface)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-capabilities-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-format-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:surface-format)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-properties-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-plane-properties-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-mode-properties-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-plane-info-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:mode
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-display-plane-capabilities-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:capabilities)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-shared-present-surface-capabilities-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-16-bit-storage-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-subgroup-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:subgroup-size
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-subgroup-extended-types-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-memory-requirements-info-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:buffer)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-buffer-memory-requirements-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-create-info)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-memory-requirements-info-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-sparse-memory-requirements-info-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-image-memory-requirements-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-create-info
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-requirements-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sparse-image-memory-requirements-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory-requirements)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-point-clipping-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-dedicated-requirements))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-dedicated-allocate-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-view-usage-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:usage)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-tessellation-domain-origin-state-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:domain-origin)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sampler-ycbcr-conversion-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:conversion)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sampler-ycbcr-conversion-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:format
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-bind-image-plane-memory-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:plane-aspect)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-plane-memory-requirements-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:plane-aspect)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-sampler-ycbcr-conversion-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sampler-ycbcr-conversion-image-format-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-texture-l-o-d-gather-format-properties-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-conditional-rendering-begin-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:buffer
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-protected-submit-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:protected-submit)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-protected-memory-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:protected-memory)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-protected-memory-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-queue-info-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-coverage-to-color-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-sampler-filter-minmax-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sample-location-ext))
  (cffi:with-foreign-slots
      ((%vk:x
        %vk:y)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sample-locations-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-sample-locations-ext))
  (cffi:with-foreign-slots
      ((%vk:attachment-index
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-sample-locations-ext))
  (cffi:with-foreign-slots
      ((%vk:subpass-index
        %vk:sample-locations-info)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-sample-locations-begin-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-sample-locations-state-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-sample-locations-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-multisample-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:max-sample-location-grid-size)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sampler-reduction-mode-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:reduction-mode)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-blend-operation-advanced-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-multi-draw-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:multi-draw)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-blend-operation-advanced-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-color-blend-advanced-state-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-inline-uniform-block-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-inline-uniform-block-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-write-descriptor-set-inline-uniform-block-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:data-size
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-pool-inline-uniform-block-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-coverage-modulation-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-format-list-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-validation-cache-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-shader-module-validation-cache-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:validation-cache)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-maintenance-3-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-maintenance-4-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:maintenance-4)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-maintenance-4-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:max-buffer-size)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-set-layout-support))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:supported)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-draw-parameters-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-float-16-int-8-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:shader-float-16
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-float-controls-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-host-query-reset-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:host-query-reset)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-shader-resource-usage-amd))
  (cffi:with-foreign-slots
      ((%vk:num-used-vgprs
        %vk:num-used-sgprs
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-shader-statistics-info-amd))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-global-priority-query-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-queue-family-global-priority-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:priority-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-utils-object-name-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:object-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-utils-object-tag-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:object-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-utils-label-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-label-name
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-debug-utils-messenger-callback-data-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-device-memory-report-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-device-memory-report-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-memory-report-callback-data-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-memory-host-pointer-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:handle-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-host-pointer-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory-type-bits)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-external-memory-host-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-conservative-rasterization-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-calibrated-timestamp-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:time-domain)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-core-properties-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-core-properties-2-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-rasterization-conservative-state-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-descriptor-indexing-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-descriptor-indexing-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-set-layout-binding-flags-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:binding-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-set-variable-descriptor-count-allocate-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:descriptor-set-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-descriptor-set-variable-descriptor-count-layout-support))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-description-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-reference-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:attachment
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-description-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-dependency-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-subpass
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-create-info-2))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-begin-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:contents)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-end-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-timeline-semaphore-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-timeline-semaphore-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-type-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-timeline-semaphore-submit-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-wait-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-signal-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-vertex-input-binding-divisor-description-ext))
  (cffi:with-foreign-slots
      ((%vk:binding
        %vk:divisor)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-vertex-input-divisor-state-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-vertex-attribute-divisor-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-p-c-i-bus-info-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:pci-domain
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-android-hardware-buffer-info-android))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:buffer)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-android-hardware-buffer-usage-android))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-android-hardware-buffer-properties-android))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:allocation-size
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-get-android-hardware-buffer-info-android))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-android-hardware-buffer-format-properties-android))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:format
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-buffer-inheritance-conditional-rendering-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-external-format-android))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:external-format)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-8-bit-storage-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-conditional-rendering-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-vulkan-memory-model-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-atomic-int-64-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-atomic-float-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-atomic-float-2-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-vertex-attribute-divisor-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-queue-family-checkpoint-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-checkpoint-data-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:stage
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-depth-stencil-resolve-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-description-depth-stencil-resolve))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-view-astc-decode-mode-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:decode-mode)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-astc-decode-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-transform-feedback-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-transform-feedback-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-rasterization-state-stream-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-representative-fragment-test-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-representative-fragment-test-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-exclusive-scissor-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-viewport-exclusive-scissor-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-corner-sampled-image-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-compute-shader-derivatives-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-shader-barycentric-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-image-footprint-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image-footprint)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-dedicated-allocation-image-aliasing-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-shading-rate-palette-nv))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-viewport-shading-rate-image-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shading-rate-image-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shading-rate-image-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-invocation-mask-features-huawei))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:invocation-mask)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-coarse-sample-location-nv))
  (cffi:with-foreign-slots
      ((%vk:pixel-x
        %vk:pixel-y
        %vk:sample)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-coarse-sample-order-custom-nv))
  (cffi:with-foreign-slots
      ((%vk:shading-rate
        %vk:sample-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-viewport-coarse-sample-order-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-mesh-shader-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:task-shader
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-mesh-shader-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-draw-mesh-tasks-indirect-command-nv))
  (cffi:with-foreign-slots
      ((%vk:task-count
        %vk:first-task)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-ray-tracing-shader-group-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-ray-tracing-shader-group-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-ray-tracing-pipeline-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-ray-tracing-pipeline-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-geometry-triangles-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:vertex-data
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-geometry-aabb-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:aabb-data
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-geometry-data-nv))
  (cffi:with-foreign-slots
      ((%vk:triangles
        %vk:aabbs)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-geometry-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:geometry-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:compacted-size
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-write-descriptor-set-acceleration-structure-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-trace-rays-indirect-command-khr))
  (cffi:with-foreign-slots
      ((%vk:width
        %vk:height
        %vk:depth)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-drm-format-modifier-properties-list-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-drm-format-modifier-properties-ext))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-image-drm-format-modifier-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:drm-format-modifier
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-drm-format-modifier-list-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:drm-format-modifier-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-drm-format-modifier-explicit-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:drm-format-modifier
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-drm-format-modifier-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:drm-format-modifier)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-stencil-usage-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:stencil-usage)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-memory-overallocation-create-info-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-density-map-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-density-map-2-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-density-map-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-density-map-2-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:subsampled-loads
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-fragment-density-map-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-scalar-block-layout-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-protected-capabilities-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-uniform-buffer-standard-layout-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-depth-clip-enable-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-rasterization-depth-clip-state-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-memory-budget-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:heap-budget
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-priority-allocate-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:priority)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-pageable-device-local-memory-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-buffer-device-address-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-buffer-device-address-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:buffer-device-address
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-device-address-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:buffer)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-opaque-capture-address-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-device-address-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-address)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-image-view-image-format-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image-view-type)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-filter-cubic-image-view-image-format-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:filter-cubic
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-imageless-framebuffer-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-framebuffer-attachments-create-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-framebuffer-attachment-image-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-render-pass-attachment-begin-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:attachment-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-texture-compression-astc-h-d-r-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-cooperative-matrix-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-cooperative-matrix-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-cooperative-matrix-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:m-size
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-ycbcr-image-arrays-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-present-frame-token-ggp))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:frame-token)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-creation-feedback-ext))
  (cffi:with-foreign-slots
      ((%vk:flags
        %vk:duration)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-creation-feedback-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-full-screen-exclusive-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-full-screen-exclusive-win32-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:hmonitor)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-surface-capabilities-full-screen-exclusive-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-performance-query-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-performance-query-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-performance-counter-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:unit
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-query-pool-performance-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:queue-family-index
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acquire-profiling-lock-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-performance-query-submit-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-headless-surface-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-coverage-reduction-mode-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-coverage-reduction-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-framebuffer-mixed-samples-combination-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:coverage-reduction-mode
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-integer-functions-2-features-intel))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-performance-value-intel))
  (cffi:with-foreign-slots
      ((%vk:type
        %vk:data)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-initialize-performance-api-info-intel))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:p-user-data)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-query-pool-performance-query-create-info-intel))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-performance-marker-info-intel))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:marker)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-performance-stream-marker-info-intel))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:marker)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-performance-override-info-intel))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-performance-configuration-acquire-info-intel))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:type)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-clock-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-index-type-uint-8-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-s-m-builtins-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:shader-s-m-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-s-m-builtins-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-shader-interlock-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-separate-depth-stencil-layouts-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-reference-stencil-layout))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:stencil-layout)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-primitive-topology-list-restart-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-description-stencil-layout))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-pipeline-executable-properties-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:pipeline)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-executable-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:stages
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-executable-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:pipeline
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-executable-statistic-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:name
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-executable-internal-representation-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:name
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-demote-to-helper-invocation-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-texel-buffer-alignment-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-texel-buffer-alignment-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-subgroup-size-control-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-subgroup-size-control-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-shader-stage-required-subgroup-size-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-subpass-shading-pipeline-create-info-huawei))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:render-pass
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-subpass-shading-properties-huawei))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-opaque-capture-address-allocate-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:opaque-capture-address)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-memory-opaque-capture-address-info))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-line-rasterization-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-line-rasterization-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-rasterization-line-state-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-pipeline-creation-cache-control-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-vulkan-1-1-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:storage-buffer-16-bit-access
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-vulkan-1-1-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-uuid
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-vulkan-1-2-features))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-vulkan-1-2-properties))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:driver-id
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-compiler-control-create-info-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-coherent-memory-features-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-tool-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:name
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sampler-custom-border-color-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-custom-border-color-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-custom-border-color-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sampler-border-color-component-mapping-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:components
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-border-color-swizzle-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-geometry-triangles-data-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:vertex-format
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-geometry-aabbs-data-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:data
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-geometry-instances-data-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-geometry-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:geometry-type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-build-geometry-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:type
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-transform-matrix-khr))
  (cffi:with-foreign-slots
      ((%vk:matrix)
       ptr
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-device-address-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:acceleration-structure)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-copy-acceleration-structure-to-memory-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-copy-memory-to-acceleration-structure-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-ray-tracing-pipeline-interface-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-extended-dynamic-state-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-copy-command-transform-info-qcom))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:transform)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-buffer-inheritance-render-pass-transform-info-qcom))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:transform
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-diagnostics-config-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-device-diagnostics-config-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-subgroup-uniform-control-flow-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-robustness-2-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-image-robustness-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-subpass-shading-features-huawei))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:subpass-shading)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-image-atomic-int-64-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-fragment-shading-rate-attachment-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-fragment-shading-rate-state-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:fragment-size
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-shading-rate-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-shading-rate-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:sample-counts
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-terminate-invocation-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-shading-rate-enums-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-fragment-shading-rate-enums-properties-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-fragment-shading-rate-enum-state-create-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-mutable-descriptor-type-features-valve))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-mutable-descriptor-type-list-valve))
  (cffi:with-foreign-slots
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-mutable-descriptor-type-create-info-valve))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-external-memory-r-d-m-a-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-memory-barrier-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-stage-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-memory-barrier-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:src-stage-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-dependency-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:dependency-flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-semaphore-submit-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:semaphore
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-buffer-submit-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:command-buffer
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-submit-info-2-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-queue-family-checkpoint-properties-2-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:checkpoint-execution-stage-mask)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-checkpoint-data-2-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:stage
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-synchronization-2-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-capabilities-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-session-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-session-parameters-add-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:vps-std-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-session-parameters-create-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-vcl-frame-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-emit-picture-parameters-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:vps-id
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-nalu-slice-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:ctb-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-profile-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:std-profile-idc)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-dpb-slot-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:slot-index
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-video-encode-h265-reference-lists-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-integer-dot-product-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-shader-integer-dot-product-properties-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-drm-properties-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:has-primary
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-ray-tracing-motion-blur-features-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-geometry-motion-triangles-data-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:vertex-data)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-motion-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:max-instances
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-srt-data-nv))
  (cffi:with-foreign-slots
      ((%vk:sx
        %vk:a
        %vk:b
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-srt-motion-instance-nv))
  (cffi:with-foreign-slots
      ((%vk:transform-t-0
        %vk:transform-t-1
        %vk:instance-custom-index-and-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-matrix-motion-instance-nv))
  (cffi:with-foreign-slots
      ((%vk:transform-t-0
        %vk:transform-t-1
        %vk:instance-custom-index-and-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-acceleration-structure-motion-instance-nv))
  (cffi:with-foreign-slots
      ((%vk:type
        %vk:flags
        %vk:data)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-memory-get-remote-address-info-nv))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-import-memory-buffer-collection-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:collection
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-collection-image-create-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:collection
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-collection-buffer-create-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:collection
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-collection-create-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:collection-token)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-collection-properties-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:memory-type-bits
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-constraints-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:create-info
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-sysmem-color-space-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:color-space)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-format-constraints-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-image-constraints-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-buffer-collection-constraints-info-fuchsia))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:min-buffer-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-r-g-b-a-1-0-x-6-formats-features-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-format-properties-3-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:linear-tiling-features
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-drm-format-modifier-properties-list-2-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:drm-format-modifier-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-drm-format-modifier-properties-2-ext))
  (cffi:with-foreign-slots
      ((%vk:drm-format-modifier
        %vk:drm-format-modifier-plane-count
        %vk:drm-format-modifier-tiling-features)
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-android-hardware-buffer-format-properties-2-android))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:format
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-pipeline-rendering-create-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:view-mask
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-rendering-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-rendering-attachment-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image-view
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-rendering-fragment-shading-rate-attachment-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image-view
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-rendering-fragment-density-map-attachment-info-ext))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image-view
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-physical-device-dynamic-rendering-features-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-command-buffer-inheritance-rendering-info-khr))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-attachment-sample-count-info-amd))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:color-attachment-count
...
(defmethod cffi:translate-from-foreign (ptr (type %vk:c-multiview-per-view-attributes-info-nvx))
  (cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
