...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-i-os-surface-create-info-mvk))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:flags
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-physical-device-multiview-per-view-attributes-properties-nv-x))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-bind-acceleration-structure-memory-info-khr))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-acceleration-structure-memory-requirements-info-khr))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:type
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-physical-device-ray-tracing-features-khr))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:ray-tracing
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-physical-device-ray-tracing-properties-khr))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-strided-buffer-region-khr))
  `(cffi:with-foreign-slots
      ((%vk:buffer
        %vk:offset
        %vk:stride
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-image-view-handle-info-nv-x))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:image-view
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-image-view-address-properties-nv-x))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:device-address
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-acceleration-structure-build-offset-info-khr))
  `(cffi:with-foreign-slots
      ((%vk:primitive-count
        %vk:primitive-offset
        %vk:first-vertex
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-acceleration-structure-create-geometry-type-info-khr))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:geometry-type
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-acceleration-structure-version-khr))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:version-data)
...
(defmethod cffi:expand-from-foreign (ptr (type %vk:c-deferred-operation-info-khr))
  `(cffi:with-foreign-slots
      ((%vk:s-type
        %vk:p-next
        %vk:operation-handle)
